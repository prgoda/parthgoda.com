...
**Time commitment:** 3 to 5 hours per week. Weeks 1 to 2 are lighter (learning). Weeks 3 to 6 are hands-on builds that require real effort. The more you build, the faster mastery comes.
...
- Complete Clay University modules 1 to 5
...
- Complete Clay University modules 6 to 10
...
## Phase 2, AI + Personalization (Weeks 3 to 4)
...
| Lead Scoring | Given company size + tech stack + growth signals, score 1 to 10 with reason |
| Objection Prediction | What objections would this persona likely raise to your product? |

---

## Phase 3, Real Workflows (Weeks 5 to 6)
