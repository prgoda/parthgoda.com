...
import { loginAction } from "@/app/network/actions";
import { buttonClass } from "@/components/network/ui";
import { passphrase } from "@/lib/network/auth";
...
export default async function NetworkLoginPage({
  ...
  if (!passphrase()) redirect("/network");
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center">
      ...
      >
        ...
        <input type="hidden" name="next" value={next ?? "/network"} />
        <input
          type="password"
          name="passphrase"
          autoFocus
